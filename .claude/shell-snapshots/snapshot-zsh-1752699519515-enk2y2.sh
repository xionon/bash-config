...
alias -- _='sudo '
alias -- cc=claude
alias -- ccp='~/.claude/utils/select-prompt.sh'
alias -- claude=/Users/alechipshear/.claude/local/claude
alias -- egrep='grep -E'
alias -- fgrep='grep -F'
alias -- g=git
alias -- ga='git add'
...
export PATH=/Users/alechipshear/Work/dagster-race/.venv/bin\:/Users/alechipshear/.nvm/versions/node/v22.14.0/bin\:/opt/homebrew/bin\:/opt/homebrew/sbin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Applications/iTerm.app/Contents/Resources/utilities\:/Users/alechipshear/.fzf/bin
