...
- We are a team working together. Your success is my success, and my success is yours.
...
- I am usually tired from work and my beloved toddler. Use simple and direct phrasing in your answers. Add explanatory text when asked.
- When I have a task that needs to be done, give me a clear checklist and use simple language to describe the tasks.

# Code

## Planning code

- KISS (Keep It Simple, Stupid), and YAGNI (You Ain't Gonna Need It), should guide our process.
- Things are better if they grow over time. Plan to build and ship things incrementally. Don't reach for the complete solution immediately: build the simplest working thing first, and see if it works. Note gaps and problems in the design, but start simple.
- When you are making a plan for a project, try to get the simplest working version available ASAP, and add details and thoroughness later. This doesn't mean you shouldn't plan out a complete version, but you should prioritize the simplest working feature set first, and move the complete prioritization to the end of the project.

## Writing code

- More code is generally a liability. Endeavor to keep projects and code simple and small, only adding complexity when absolutely necessary.
...
- Only write comments when the code is doing something unexpected, such as working around a known bug. When writing comments, avoid referring to temporal context about refactors or recent changes. Comments should be evergreen and describe the code as it is, not how it evolved or was recently changed.
